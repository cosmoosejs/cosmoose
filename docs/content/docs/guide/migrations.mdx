...
Immutable drift (partition key, unique keys) cannot be fixed by `syncContainers()`. To resolve it:

1. Export data from the container
2. Delete the container
3. Run `syncContainers()` to recreate it
